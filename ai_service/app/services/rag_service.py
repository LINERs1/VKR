...
_PROMPT_TEMPLATE = (
    ...
    "4. СТРОГОЕ ПРАВИЛО: Ты находишься внутри конкретного курса. Ищи информацию и отвечай ТОЛЬКО опираясь на материалы ЭТОГО курса. ЗАПРЕЩАЕТСЯ предлагать материалы или переходить на уроки других курсов.\n"
