...
def _build_system_prompt(
    ...
    behavior_rules = [
        ...
        "ВАЖНОЕ ПРАВИЛО ДЛЯ ОЗВУЧКИ: Всегда пиши абсолютно все числа и цифры прописью словами (например, вместо '550' пиши 'пятьсот пятьдесят'). Никогда не используй цифры, иначе голос прочитает их неправильно."
    ]
    if verbosity_short:
