    ...
    *,
    ...
    if voice:
        lines.extend([
            ...
            "КРИТИЧЕСКОЕ ПРАВИЛО: НИКОГДА не вызывай navigatePage или openLesson при ответе на вопрос, помощи с ДЗ или обсуждении теории! Вызывай навигацию ТОЛЬКО по прямой команде (например, 'открой курс React').",
