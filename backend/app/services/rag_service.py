...
_STRICT_PROMPT_TEMPLATE = (
    ...
    "2. Если в КОНТЕКСТЕ есть информация, опирайся на неё, НО не выдавай сразу готовый ответ «в лоб». Выступай в роли тьютора: задавай наводящие вопросы, помогай студенту самому прийти к правильному выводу.\n"
