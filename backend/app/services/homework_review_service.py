...
Проверь домашнее задание ученика: код, тесты с вариантами ответов (если есть), письменную часть и при необходимости соответствие автотестам (pytest), если они указаны в задании.
...
4. Структура ответа:
   ...
   - Разбор кода (пункты)
   - Разбор тестов с вариантами (верно / неверно по каждому вопросу)
...
5. Не выдумывай ошибки; если работа идеальна — похвали и поставь 5.
